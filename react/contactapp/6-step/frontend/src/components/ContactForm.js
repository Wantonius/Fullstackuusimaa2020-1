...
class ContactForm extends React.Component {
	...
	onSubmit = (event) => {
		...
		this.props.logger.hocLog(this.props.logger.state.LOG_INFO,"ContactForm","onSubmit:"+this.props.mode)
...
export default HocLogger(connect(mapStateToProps)(ContactForm))